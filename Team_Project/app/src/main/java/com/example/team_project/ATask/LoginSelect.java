package com.example.team_project.ATask;
...
import static com.example.team_project.Common.CommonMethod.ipConfig;
import static com.example.team_project.LoginActivity.loginDTO;
...
public class LoginSelect extends AsyncTask<Void, Void, Void> {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            String postURL = ipConfig + "/test/and_login";
            // 전송
    ...
    public MemberDTO readMessage(InputStream inputStream) throws IOException {
        ...
        while (reader.hasNext()) {
            ...
            }else if (readStr.equals("tell")) {
                tell = reader.nextString();
            }else {
                reader.skipValue();
            }
        }
        reader.endObject();
        return new MemberDTO(id, pw, email, addr , tell);
